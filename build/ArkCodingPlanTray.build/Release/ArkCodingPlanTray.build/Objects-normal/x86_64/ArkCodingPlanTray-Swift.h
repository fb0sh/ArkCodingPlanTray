...
#ifndef ARKCODINGPLANTRAY_SWIFT_H
#define ARKCODINGPLANTRAY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ArkCodingPlanTray",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17ArkCodingPlanTray11AppDelegate")
...
@class NSEvent;
SWIFT_CLASS("_TtC17ArkCodingPlanTray12PopoverPanel")
...
@class NSCoder;
@class NSWindow;
SWIFT_CLASS("_TtC17ArkCodingPlanTray24SettingsWindowController")
